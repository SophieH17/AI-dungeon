class DungeonGame {
    ...
    async startGame() {
        ...
        try {
            ...
            // this.displayMessage('Error starting game. Please check your API key and try again.', 'error');
            // Reset the display state on error
    ...
    async handleCommand(e) {
        ...
        try {
            ...
            console.error('Error:', error);
            this.displayMessage('Error processing command. Please check your API key and try again.', 'error');
        } finally {
            this.setLoading(false);
